 ...
 */
package com.avro.generic;

import org.apache.avro.AvroRuntimeException;
import com.avro.Schema;
import com.avro.Schema.Field;
import com.avro.data.RecordBuilderBase;
import com.avro.generic.GenericData.Record;
...
public class GenericRecordBuilder extends RecordBuilderBase<Record> {
  private final com.avro.generic.GenericData.Record record;
  ...
  public GenericRecordBuilder(Schema schema) {
    super(schema, com.avro.generic.GenericData.get());
    record = new com.avro.generic.GenericData.Record(schema);
  }
   ...
   */
  public GenericRecordBuilder(com.avro.generic.GenericRecordBuilder other) {
    super(other, com.avro.generic.GenericData.get());
    record = new com.avro.generic.GenericData.Record(other.record, /* deepCopy = */ true);
  }
  ...
  public GenericRecordBuilder(Record other) {
    super(other.getSchema(), com.avro.generic.GenericData.get());
    record = new com.avro.generic.GenericData.Record(other, /* deepCopy = */ true);
   ...
   */
  public com.avro.generic.GenericRecordBuilder set(String fieldName, Object value) {
   ...
   * @return a reference to the RecordBuilder.
   */
  public com.avro.generic.GenericRecordBuilder set(Field field, Object value) {
   ...
   * @return a reference to the RecordBuilder.
   */
  protected com.avro.generic.GenericRecordBuilder set(int pos, Object value) {
   ...
   * @return a reference to the RecordBuilder.
   */
  private com.avro.generic.GenericRecordBuilder set(Field field, int pos, Object value) {
   ...
   * @return a reference to the RecordBuilder.
   */
  public com.avro.generic.GenericRecordBuilder clear(String fieldName) {
   ...
   * @return a reference to the RecordBuilder.
   */
  public com.avro.generic.GenericRecordBuilder clear(Field field) {
   ...
   * @return a reference to the RecordBuilder.
   */
  protected com.avro.generic.GenericRecordBuilder clear(int pos) {
    record.put(pos, null);
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    com.avro.generic.GenericRecordBuilder other = (com.avro.generic.GenericRecordBuilder) obj;
    if (record == null) {
