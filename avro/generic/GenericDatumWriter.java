...
import com.avro.Conversion;
import com.avro.LogicalType;
...
public class GenericDatumWriter<D> implements DatumWriter<D> {
  private final com.avro.generic.GenericData data;
  private Schema root;

  public GenericDatumWriter() { this(com.avro.generic.GenericData.get()); }

  protected GenericDatumWriter(com.avro.generic.GenericData data) { this.data = data; }
  ...
  public GenericDatumWriter(Schema root, com.avro.generic.GenericData data) {
    this(data);
    setSchema(root);
  }

  /** Return the {@link com.avro.generic.GenericData} implementation. */
  public com.avro.generic.GenericData getData() { return data; }
