...
import com.avro.Schema.Type;
import com.avro.io.*;
import com.avro.io.parsing.ResolvingGrammarGenerator;
//import com.avro.util.Utf8;
...
public class GenericData {
  ...
  private static final com.avro.generic.GenericData INSTANCE = new com.avro.generic.GenericData();
  ...
  public static void setStringType(Schema s, StringType stringType) {
    ...
    if (stringType == StringType.String)
      s.addProp(com.avro.generic.GenericData.STRING_PROP, com.avro.generic.GenericData.STRING_TYPE_STRING);
  }

  /** Return the singleton instance. */
  public static com.avro.generic.GenericData get() { return INSTANCE; }

  /** For subclasses.  Applications normally use {@link com.avro.generic.GenericData#get()}. */
  public GenericData() {
    this(null);
  }
  ...
  public static class Record implements GenericRecord, Comparable<Record> {
    ...
    @Override public boolean equals(Object o) {
      ...
      return com.avro.generic.GenericData.get().compare(this, that, schema, true) == 0;
    }
    @Override public int hashCode() {
      return com.avro.generic.GenericData.get().hashCode(this, schema);
    }
    @Override public int compareTo(Record that) {
      return com.avro.generic.GenericData.get().compare(this, that, schema);
    }
    @Override public String toString() {
      return com.avro.generic.GenericData.get().toString(this);
    }
  }
  ...
  public static class Array<T> extends AbstractList<T>
    ...
    public int compareTo(GenericArray<T> that) {
      return com.avro.generic.GenericData.get().compare(this, that, this.getSchema());
    }
    @Override
    public void reverse() {
      int left = 0;
  ...
  public <T> T deepCopy(Schema schema, T value) {
    ...
    switch (schema.getType()) {
      case ARRAY:
        ...
        List<Object> arrayCopy = new com.avro.generic.GenericData.Array<Object>(
  ...
  public Object createFixed(Object old, Schema schema) {
    if ((old instanceof GenericFixed)
      ...
      return old;
    return new com.avro.generic.GenericData.Fixed(schema);
  }
   ...
   * a {@link com.avro.generic.GenericData.Record}.
   */
  public Object newRecord(Object old, Schema schema) {
    ...
    return new com.avro.generic.GenericData.Record(schema);
  }
