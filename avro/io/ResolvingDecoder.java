...
import com.avro.io.parsing.Symbol;
...
/**
 * {@link com.avro.io.Decoder} that performs type-resolution between the reader's and
 * writer's schemas.
 *
...
public class ResolvingDecoder extends ValidatingDecoder {
  ...
  private com.avro.io.Decoder backup;

  ResolvingDecoder(Schema writer, Schema reader, com.avro.io.Decoder in)
    throws IOException {
   ...
   * @throws IOException
   */
  private ResolvingDecoder(Object resolver, com.avro.io.Decoder in)
    throws IOException {
   ...
   * {@link com.avro.io.ResolvingDecoder#ResolvingDecoder(Object, Decoder)}. The
   ...
   *
   * This method is useful because {@link com.avro.io.ResolvingDecoder}
   ...
   *     }
   * </pre>
   * Note that {@link com.avro.io.ResolvingDecoder} will return only the
