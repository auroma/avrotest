...
public class BinaryDecoder extends Decoder {
  ...
  com.avro.io.BinaryDecoder configure(InputStream in, int bufferSize) {
    configureSource(bufferSize, new InputStreamByteSource(in));
    return this;
  }

  com.avro.io.BinaryDecoder configure(byte[] data, int offset, int length) {
   ...
   * the InputStream returned by {@link com.avro.io.BinaryDecoder.inputStream} to access the
  ...
  static class BufferAccessor {
    private final com.avro.io.BinaryDecoder decoder;
    private byte[] buf;
    private int pos;
    private int limit;
    boolean detached = false;

    private BufferAccessor(com.avro.io.BinaryDecoder decoder) {
  ...
  abstract static class ByteSource extends InputStream {
    ...
    protected void attach(int bufferSize, com.avro.io.BinaryDecoder decoder) {
