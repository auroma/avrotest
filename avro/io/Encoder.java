 ...
 * maps).  Some implementations of {@link com.avro.io.Encoder} handle the
...
public abstract class Encoder implements Flushable {
   ...
   *  com.avro.io.Encoder} method (e.g., {@link #writeLong}).  When all items
   ...
   * other write methods of {@link com.avro.io.Encoder}. The number of calls
