...
import com.avro.io.parsing.Parser;
import com.avro.io.parsing.Symbol;
import com.avro.io.parsing.ValidatingGrammarGenerator;
 ...
 * <p/>
 * Use {@link com.avro.io.DecoderFactory#validatingDecoder(Schema, Decoder)} to construct
 * and configure.
 * <p/>
...
public class ValidatingDecoder extends ParsingDecoder
  ...
  public com.avro.io.ValidatingDecoder configure(Decoder in) throws IOException {
    this.parser.reset();
    this.in = in;
    return this;
  }
