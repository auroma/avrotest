...
import com.avro.io.parsing.JsonGrammarGenerator;
...
public class JsonEncoder extends ParsingEncoder implements Parser.ActionHandler {
   ...
   */
  public com.avro.io.JsonEncoder configure(OutputStream out) throws IOException {
   ...
   */
  @Deprecated
  public com.avro.io.JsonEncoder configure(JsonGenerator generator) throws IOException {
    if (null == generator)
