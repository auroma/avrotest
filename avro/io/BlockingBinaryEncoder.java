  ...
  */
  ...
  private static class BlockedValue {
    public enum State {
       ...
       * case, {@link com.avro.io.BlockingBinaryEncoder.BlockedValue#start} points to the start of the
       ...
       * overflow state.  In this case, {@link com.avro.io.BlockingBinaryEncoder.BlockedValue#start} is zero. The
  ...
  com.avro.io.BlockingBinaryEncoder configure(OutputStream out, int blockBufferSize,
