 ...
 * @see com.avro.io.DirectBinaryEncoder
 */
...
public class EncoderFactory {
  ...
  private static final com.avro.io.EncoderFactory DEFAULT_FACTORY =
   ...
   */
  public static com.avro.io.EncoderFactory get() {
   ...
   */
  public com.avro.io.EncoderFactory configureBufferSize(int size) {
    if (size < 32)
      size = 32;
   ...
   */
  public com.avro.io.EncoderFactory configureBlockSize(int size) {
  ...
  public BinaryEncoder directBinaryEncoder(OutputStream out, BinaryEncoder reuse) {
    if (null == reuse || !reuse.getClass().equals(com.avro.io.DirectBinaryEncoder.class)) {
      return new com.avro.io.DirectBinaryEncoder(out);
    } else {
  ...
  private static class DefaultEncoderFactory extends com.avro.io.EncoderFactory {
    @Override
    public com.avro.io.EncoderFactory configureBlockSize(int size) {
