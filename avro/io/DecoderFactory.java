...
public class DecoderFactory {
  private static final com.avro.io.DecoderFactory DEFAULT_FACTORY = new DefaultDecoderFactory();
   ...
   */
  @Deprecated
  public static com.avro.io.DecoderFactory defaultFactory() {
    return get();
  }
   ...
   */
  public static com.avro.io.DecoderFactory get() {
   ...
   * </pre>
   */
  public com.avro.io.DecoderFactory configureDecoderBufferSize(int size) {
    if (size < 32)
      size = 32;
  ...
  private static class DefaultDecoderFactory extends com.avro.io.DecoderFactory {
    @Override
    public com.avro.io.DecoderFactory configureDecoderBufferSize(int bufferSize) {
