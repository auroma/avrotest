...
public class SkipParser extends Parser {
  ...
  public SkipParser(com.avro.io.parsing.Symbol root, ActionHandler symbolHandler,
  ...
  public final void skipTo(int target) throws IOException {
    ...
    while (target < pos) {
      ...
      while (top.kind != com.avro.io.parsing.Symbol.Kind.TERMINAL) {
        if (top.kind == com.avro.io.parsing.Symbol.Kind.IMPLICIT_ACTION
            || top.kind == com.avro.io.parsing.Symbol.Kind.EXPLICIT_ACTION) {
  ...
  public final void skipRepeater() throws IOException {
    int target = pos;
    com.avro.io.parsing.Symbol repeater = stack[--pos];
    assert repeater.kind == com.avro.io.parsing.Symbol.Kind.REPEATER;
