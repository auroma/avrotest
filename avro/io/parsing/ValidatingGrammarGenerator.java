...
public class ValidatingGrammarGenerator {
  ...
  public com.avro.io.parsing.Symbol generate(Schema schema) {
    return com.avro.io.parsing.Symbol.root(generate(schema, new HashMap<LitS, com.avro.io.parsing.Symbol>()));
  }
   ...
   */
  public com.avro.io.parsing.Symbol generate(Schema sc, Map<LitS, com.avro.io.parsing.Symbol> seen) {
    switch (sc.getType()) {
    case NULL:
    ...
    case FIXED:
      return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.intCheckAction(sc.getFixedSize()),
          com.avro.io.parsing.Symbol.FIXED);
    case ENUM:
      return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.intCheckAction(sc.getEnumSymbols().size()),
          com.avro.io.parsing.Symbol.ENUM);
    case ARRAY:
      return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.repeat(com.avro.io.parsing.Symbol.ARRAY_END, generate(sc.getElementType(), seen)),
    ...
    case MAP:
      return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.repeat(com.avro.io.parsing.Symbol.MAP_END,
              generate(sc.getValueType(), seen), com.avro.io.parsing.Symbol.STRING),
          com.avro.io.parsing.Symbol.MAP_START);
    case RECORD: {
      LitS wsc = new LitS(sc);
      com.avro.io.parsing.Symbol rresult = seen.get(wsc);
      if (rresult == null) {
        com.avro.io.parsing.Symbol[] production = new com.avro.io.parsing.Symbol[sc.getFields().size()];
    ...
    case UNION:
      ...
      com.avro.io.parsing.Symbol[] symbols = new com.avro.io.parsing.Symbol[subs.size()];
      ...
      return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.alt(symbols, labels), Symbol.UNION);
