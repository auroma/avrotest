...
import com.avro.io.Encoder;
import com.avro.io.EncoderFactory;
...
public class ResolvingGrammarGenerator extends ValidatingGrammarGenerator {
   ...
   * @throws IOException
   */
  public final com.avro.io.parsing.Symbol generate(Schema writer, Schema reader)
    throws IOException {
    return com.avro.io.parsing.Symbol.root(generate(writer, reader, new HashMap<ValidatingGrammarGenerator.LitS, com.avro.io.parsing.Symbol>()));
  }
   ...
   * @throws IOException
   */
  public com.avro.io.parsing.Symbol generate(Schema writer, Schema reader,
                                             Map<ValidatingGrammarGenerator.LitS, com.avro.io.parsing.Symbol> seen) throws IOException
  {
    ...
    if (writerType == readerType) {
      switch (writerType) {
      case NULL:
        return com.avro.io.parsing.Symbol.NULL;
      case BOOLEAN:
        return com.avro.io.parsing.Symbol.BOOLEAN;
      case INT:
        return com.avro.io.parsing.Symbol.INT;
      case LONG:
        return com.avro.io.parsing.Symbol.LONG;
      case FLOAT:
        return com.avro.io.parsing.Symbol.FLOAT;
      case DOUBLE:
        return com.avro.io.parsing.Symbol.DOUBLE;
      case STRING:
        return com.avro.io.parsing.Symbol.STRING;
      case BYTES:
        return com.avro.io.parsing.Symbol.BYTES;
      case FIXED:
        if (writer.getFullName().equals(reader.getFullName())
            && writer.getFixedSize() == reader.getFixedSize()) {
          return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.intCheckAction(writer.getFixedSize()),
              com.avro.io.parsing.Symbol.FIXED);
        }
        break;
      ...
      case ENUM:
        if (writer.getFullName() == null
          ...
          return com.avro.io.parsing.Symbol.seq(mkEnumAdjust(writer.getEnumSymbols(),
                  reader.getEnumSymbols()), com.avro.io.parsing.Symbol.ENUM);
        }
        break;
      ...
      case MAP:
        return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.repeat(com.avro.io.parsing.Symbol.MAP_END,
                ...
                reader.getValueType(), seen), com.avro.io.parsing.Symbol.STRING),
      ...
      case LONG:
        switch (writerType) {
        case INT:
          return com.avro.io.parsing.Symbol.resolve(super.generate(writer, seen), com.avro.io.parsing.Symbol.LONG);
        }
        break;
      ...
      case FLOAT:
        ...
        case INT:
        case LONG:
          return com.avro.io.parsing.Symbol.resolve(super.generate(writer, seen), com.avro.io.parsing.Symbol.FLOAT);
        }
        break;
      ...
      case DOUBLE:
        ...
        case LONG:
        case FLOAT:
          return com.avro.io.parsing.Symbol.resolve(super.generate(writer, seen), com.avro.io.parsing.Symbol.DOUBLE);
        }
        break;
      ...
      case BYTES:
        switch (writerType) {
        case STRING:
          return com.avro.io.parsing.Symbol.resolve(super.generate(writer, seen), com.avro.io.parsing.Symbol.BYTES);
        }
        break;
      ...
      case STRING:
        switch (writerType) {
        case BYTES:
          return com.avro.io.parsing.Symbol.resolve(super.generate(writer, seen), com.avro.io.parsing.Symbol.STRING);
        }
        break;
      ...
      case UNION:
        ...
        if (j >= 0) {
          com.avro.io.parsing.Symbol s = generate(writer, reader.getTypes().get(j), seen);
          return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.unionAdjustAction(j, s), com.avro.io.parsing.Symbol.UNION);
        }
        break;
      case NULL:
      case BOOLEAN:
    ...
    return com.avro.io.parsing.Symbol.error("Found " + writer.getFullName()
                        + ", expecting " + reader.getFullName());
  }

  private com.avro.io.parsing.Symbol resolveUnion(Schema writer, Schema reader,
                                                  Map<ValidatingGrammarGenerator.LitS, com.avro.io.parsing.Symbol> seen) throws IOException {
    List<Schema> alts = writer.getTypes();
    final int size = alts.size();
    com.avro.io.parsing.Symbol[] symbols = new com.avro.io.parsing.Symbol[size];
    String[] labels = new String[size];

    /**
     * We construct a symbol without filling the arrays. Please see
     * {@link com.avro.io.parsing.Symbol#production} for the reason.
     */
    int i = 0;
    for (Schema w : alts) {
    ...
    return com.avro.io.parsing.Symbol.seq(com.avro.io.parsing.Symbol.alt(symbols, labels),
                      com.avro.io.parsing.Symbol.writerUnionAction());
  }

  private com.avro.io.parsing.Symbol resolveRecords(Schema writer, Schema reader,
                                                    Map<ValidatingGrammarGenerator.LitS, com.avro.io.parsing.Symbol> seen) throws IOException {
    ValidatingGrammarGenerator.LitS wsc = new LitS2(writer, reader);
    com.avro.io.parsing.Symbol result = seen.get(wsc);
    if (result == null) {
      ...
      for (Field rf : rfields) {
        ...
        if (writer.getField(fname) == null) {
          if (rf.defaultValue() == null) {
            result = com.avro.io.parsing.Symbol.error("Found " + writer.getFullName()
                                  + ", expecting " + reader.getFullName()
      ...
      com.avro.io.parsing.Symbol[] production = new com.avro.io.parsing.Symbol[count];
      production[--count] = com.avro.io.parsing.Symbol.fieldOrderAction(reordered);

      /**
       * We construct a symbol without filling the array. Please see
       * {@link com.avro.io.parsing.Symbol#production} for the reason.
       */
      result = com.avro.io.parsing.Symbol.seq(production);
      seen.put(wsc, result);
      ...
      for (Field wf : wfields) {
        ...
        if (rf == null) {
          production[--count] =
            com.avro.io.parsing.Symbol.skipAction(generate(wf.schema(), wf.schema(), seen));
        } else {
          production[--count] =
      ...
      for (Field rf : rfields) {
        ...
        if (wf == null) {
          ...
          production[--count] = com.avro.io.parsing.Symbol.defaultStartAction(bb);
          production[--count] = generate(rf.schema(), rf.schema(), seen);
          production[--count] = com.avro.io.parsing.Symbol.DEFAULT_END_ACTION;
        }
      }
    }
    return result;
  ...
  private static com.avro.io.parsing.Symbol mkEnumAdjust(List<String> wsymbols,
    ...
    return com.avro.io.parsing.Symbol.enumAdjustAction(rsymbols.size(), adjustments);
  }
   ...
   */
  private boolean hasMatchError(com.avro.io.parsing.Symbol sym) {
    if (sym instanceof com.avro.io.parsing.Symbol.ErrorAction) {
      return true;
    } else {
      for (int i = 0; i < sym.production.length; i += 1) {
        if (sym.production[i] instanceof com.avro.io.parsing.Symbol.ErrorAction) {
          return true;
        }
      }
    }
  ...
  private int bestBranch(Schema r, Schema w, Map<ValidatingGrammarGenerator.LitS, Symbol> seen) throws IOException {
