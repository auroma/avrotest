...
import com.avro.io.BinaryEncoder;
import com.avro.io.DatumWriter;
...
public class DataFileWriter<D> implements Closeable, Flushable {
   ...
   */
  public com.avro.file.DataFileWriter<D> setCodec(CodecFactory c) {
    assertNotOpen();
   ...
   *   this DataFileWriter
   */
  public com.avro.file.DataFileWriter<D> setSyncInterval(int syncInterval) {
  ...
  public com.avro.file.DataFileWriter<D> create(Schema schema, File file) throws IOException {
    return create(schema, new SyncableFileOutputStream(file), null);
  }

  /** Open a new file for data matching a schema with a random sync. */
  public com.avro.file.DataFileWriter<D> create(Schema schema, OutputStream outs)
    throws IOException {
    return create(schema, outs, null);
  }

  /** Open a new file for data matching a schema with an explicit sync. */
  public com.avro.file.DataFileWriter<D> create(Schema schema, OutputStream outs, byte[] sync)
    throws IOException {
    assertNotOpen();
  ...
  public com.avro.file.DataFileWriter<D> appendTo(File file) throws IOException {
   ...
   */
  public com.avro.file.DataFileWriter<D> appendTo(SeekableInput in, OutputStream out)
    throws IOException {
    assertNotOpen();
  ...
  private com.avro.file.DataFileWriter<D> setMetaInternal(String key, byte[] value) {
    assertNotOpen();
    meta.put(key, value);
    return this;
  }

  private com.avro.file.DataFileWriter<D> setMetaInternal(String key, String value) {
    try {
  ...
  public com.avro.file.DataFileWriter<D> setMeta(String key, byte[] value) {
  ...
  /** Set a metadata property. */
  public com.avro.file.DataFileWriter<D> setMeta(String key, String value) {
    try {
  ...
  /** Set a metadata property. */
  public com.avro.file.DataFileWriter<D> setMeta(String key, long value) {
