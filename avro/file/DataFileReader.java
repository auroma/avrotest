...
import com.avro.io.DatumReader;
import com.avro.io.DecoderFactory;
...
import static com.avro.file.DataFileConstants.MAGIC;
import static com.avro.file.DataFileConstants.SYNC_SIZE;
...
public class DataFileReader<D>
  ...
  public static <D> FileReader<D> openReader(SeekableInput in,
    ...
    if (Arrays.equals(MAGIC, magic))              // current format
      return new com.avro.file.DataFileReader<D>(in, reader);
   ...
   *             point.
   */
  public static <D> com.avro.file.DataFileReader<D> openReader(SeekableInput in,
                                                               DatumReader<D> reader,
                                                               Header header,
                                                               boolean sync)
      throws IOException {
    com.avro.file.DataFileReader<D> dreader = new com.avro.file.DataFileReader<D>(in, reader, header);
